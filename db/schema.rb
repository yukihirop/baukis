...
ActiveRecord::Schema.define(version: 20160820043621) do
  ...
  add_index "customers", ["birth_month", "family_name_kana", "given_name_kana"], name: "index_customers_on_birth_mday_and_furigana", using: :btree
  add_index "customers", ["birth_year", "birth_mday"], name: "index_customers_on_birth_year_and_birth_mday", using: :btree
