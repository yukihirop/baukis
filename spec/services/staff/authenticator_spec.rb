...
# app/servicesのフォルダを追加したのでspringを再起動する必要がある
describe Staff::Authenticator do
  ...
  describe '#authenticate' do
    ...
    example 'passwordが正しくてもsuspendedがtrueならfalseを返す' do
      m = build(:staff_member, suspended:true)
      expect(Staff::Authenticator.new(m).suspended_authenticate('pw')).to be_falsey
    end
